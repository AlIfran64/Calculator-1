...
public class NewJFrame extends javax.swing.JFrame {
    ...
    public void enable()
    {
        ...
        jRadioButton1.setEnabled(false);    // ON BUTTON DISABLE
        jRadioButton2.setEnabled(true);   // OFF BITTON ENABLE
    ...
    public void disable()
    {
        ...
        jRadioButton2.setEnabled(false);   // OFF BITTON DISABLE
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        num = Double.parseDouble(String.valueOf(jTextField1.getText()));
        num = Math.sqrt(num);
